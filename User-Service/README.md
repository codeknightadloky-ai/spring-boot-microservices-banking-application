...
## Maintainer
Lokesh Addanki is a Full Stack Developer with over 5 years of experience in finance, insurance, and automotive domains. He specializes in delivering cloud-native microservices and responsive front-end applications. His expertise includes migrating legacy monoliths to containerized Spring Boot services on Azure Kubernetes and GKE, as well as optimizing CI/CD pipelines to accelerate release cycles.

For questions or support regarding this service, please reach out via:
