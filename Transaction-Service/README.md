...
## Introduction
The Transaction Service is a microservice responsible for managing bank transactions. It provides APIs for creating, retrieving, and listing transactions. This project is maintained by Lokesh Addanki, focusing on robust, cloud-native financial processing.
...
## About the Developer
Lokesh Addanki is a Full Stack Developer with 5 years of experience in the finance, insurance, and automotive domains. He specializes in building cloud-native microservices and scalable backend systems using Java and Spring Boot.
